...
- **`/`** — the StressFreeClaim.ai greeting (Deskar 6 / Nexus stay behind the scenes) and the single prompt: _"Tell me what happened and we'll take it from there."_
- The subhead begins _“In your own words, a sentence is plenty.”_ The input card does not repeat the same sentence-length guidance.
- Below the input, concise marketing content explains the three-step human-review process, what damage can be reported, common questions, Nexus Development, and that this intake does not submit directly to an insurer. It must not introduce public-adjuster, fee, contract, settlement, licensing, or repair-outcome promises before counsel approval.
...
- **[AC-1]** Loading the app shows the StressFreeClaim.ai greeting, the agreed subhead, one clear way to begin without duplicate guidance, and the agreed process and service-clarity content below the intake. No console errors.
...
- `[AC-2]` entering the founder's sentence — _"My name is Martin Kaczmarek. My address is 927 11th St N, Naples, FL. A hurricane hit my house yesterday, September 15th. I'm insured by Citizens Property. I have damage to my roof and a couple of windows."_ — produces a draft carrying all five facts; a vaguer variant ("the storm last night wrecked my roof") still advances to `/gaps` rather than erroring.
